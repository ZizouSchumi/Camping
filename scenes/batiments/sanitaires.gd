...
class_name Sanitaires

const COULEUR_FOND    := Color(0.78, 0.90, 0.96, 0.85)  # bleu clair / piscine propre
const COULEUR_CONTOUR := Color(0.20, 0.50, 0.72, 1.0)   # bleu foncé
const LABEL           := "SANITAIRES"
